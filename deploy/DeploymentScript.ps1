...
[Environment]::SetEnvironmentVariable("TestrailApiKey", $OctopusParameters["TestrailApiKey"] , "Process")
[Environment]::SetEnvironmentVariable("EnforcementRegisterConfig__BaseUrl", $OctopusParameters["EnforcementRegisterConfig__BaseUrl"], "Process")
[Environment]::SetEnvironmentVariable("EnforcementRegisterConfig__ApiKey", $OctopusParameters["EnforcementRegisterConfig__ApiKey"], "Process")
[Environment]::SetEnvironmentVariable("EnforcementRegisterConfig__TimeoutMilliseconds", $OctopusParameters["EnforcementRegisterConfig__TimeoutMilliseconds"], "Process")
[Environment]::SetEnvironmentVariable("PromoteToProd", $OctopusParameters["PromoteToProd"], "Process")
...
[Environment]::SetEnvironmentVariable("Application__ClusterArn", $OctopusParameters["ClusterArn"] , "Process")
[Environment]::SetEnvironmentVariable("Application__ClusterName", $OctopusParameters["ClusterName"] , "Process")
[Environment]::SetEnvironmentVariable("Application__VpcId", $OctopusParameters["VpcId"] , "Process")
[Environment]::SetEnvironmentVariable("Application__HttpsListenerArn", $OctopusParameters["HttpsListenerArn"] , "Process")
[Environment]::SetEnvironmentVariable("Application__LoadbalancerDns", $OctopusParameters["LoadbalancerDns"] , "Process")
